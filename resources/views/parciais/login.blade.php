<div class="page">
    <div class="field">
        ...
        <input type="text" name="name" @error('name') class="input-error" @enderror value="{{ old('name') }}" placeholder="Nome Usuário" maxlength="255">
    </div>
    <div class="field">
    ...
    <div class="field btns">
        <button class="prev-4 prev mt-5">Anterior</button>
